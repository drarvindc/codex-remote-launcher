...
internal static class OrchestratorResultParserTests
{
    ...
    private const string RendererOnlySuccess = "{\"ok\":true,\"protocolVersion\":1,\"renderer\":{\"newDocumentScriptInstalled\":true,\"probe\":{\"proof\":true,\"targetGate\":\"782640499\"},\"targetUrl\":\"app://-/index.html\"}}";
    ...
    internal static int Main()
    {
        ...
        Expect("renderer-only-success", RendererOnlySuccess, true);
